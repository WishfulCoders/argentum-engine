...
val RiteOfRenewal = card("Rite of Renewal") {
    ...
    spell {
        effect = Effects.Pipeline {
            ...
            val toHandCards = chooseUpTo(2, from = yourGraveyard, selectedLabel = "Return to hand")
            toHand(toHandCards)
            ...
            val toLibrary = chooseUpTo(4, from = anyGraveyard, selectedLabel = "Shuffle into library")
