...
object SetArchetypes {
    ...
    private val allSets: Map<String, SetSynergies> = mapOf(
        ...
        "RAV" to SetSynergies(
            ...
            archetypes = listOf(
                Archetype("Boros Radiance", listOf(Color.RED, Color.WHITE),
                    "Cheap double strikers, fliers and haste punish every stumble, while radiance spells like Lightning Helix and Galvanic Arc double as removal and reach. Curve out and never stop attacking.",
                    creatureTypes = listOf("Soldier")),
                Archetype("Selesnya Convoke", listOf(Color.GREEN, Color.WHITE),
                    "Go wide with Saprolings and cheap creatures, then tap the team to convoke big spells out a turn early. Rally the Righteous and Glare of Subdual turn a board of 1/1s into a lock or a lethal alpha strike.",
                    creatureTypes = listOf("Saproling")),
                Archetype("Golgari Dredge", listOf(Color.BLACK, Color.GREEN),
                    "Dredge replaces draws with the best cards in your graveyard, so every trade feeds the engine. Removal and Saproling fodder grind the game long enough for Grave-Troll-sized threats to take over.",
                    creatureTypes = listOf("Saproling")),
                Archetype("Dimir Transmute", listOf(Color.BLUE, Color.BLACK),
                    "Transmute tutors for the exact answer or bomb you need while removal and card draw keep the board clear. Evasive threats and milling offer a second way to win the long game."),
            )
        ),
        "LRW" to SetSynergies(
            setCode = "LRW",
            ...
            archetypes = listOf(
                Archetype("Kithkin", listOf(Color.GREEN, Color.WHITE),
                    "Swarm the board with small Kithkin and pump them with lords. Cheap bodies and team buffs overwhelm opponents before the bigger tribes get going.",
                    creatureTypes = listOf("Kithkin")),
                Archetype("Merfolk", listOf(Color.WHITE, Color.BLUE),
                    "Merfolk tap and untap each other, dodge removal with protection, and slip through with islandwalk. A tempo deck that wins with lords and evasive pressure.",
                    creatureTypes = listOf("Merfolk")),
                Archetype("Faeries", listOf(Color.BLUE, Color.BLACK),
                    "Flash in fliers at the end of the opponent's turn and ambush attackers. Scion of Oona pumps and protects the flock while the Faeries peck the opponent out of the sky.",
                    creatureTypes = listOf("Faerie")),
                Archetype("Elves", listOf(Color.BLACK, Color.GREEN),
                    "Elves reward you for revealing and controlling more Elves, with deathtouch and discard backing up a midrange curve. Changelings count as Elves too.",
                    creatureTypes = listOf("Elf")),
                Archetype("Goblins", listOf(Color.BLACK, Color.RED),
                    "Boggarts attack early, trade freely, and come back from the graveyard. Boggart Shenanigans pings the opponent whenever one dies, so every chump block still deals damage.",
                    creatureTypes = listOf("Goblin")),
                Archetype("Giants", listOf(Color.RED, Color.WHITE),
                    "Survive the early turns, then drop Giants that dominate the ground. Crush Underfoot and Thundercloud Shaman hit harder with Giants on the table, and Brion Stoutarm flings them at the opponent's face.",
                    creatureTypes = listOf("Giant")),
                Archetype("Elementals", listOf(Color.BLUE, Color.RED),
                    "Evoke Elementals for a cheap one-shot effect or hardcast them for card advantage on a body. Flamekin reach and Mulldrifter card flow power a flexible tempo-value deck.",
                    creatureTypes = listOf("Elemental")),
                Archetype("Treefolk", listOf(Color.GREEN),
                    "Towering Treefolk with huge toughness wall up the ground while lords and Treefolk payoffs turn them into threats. Pair with any color for removal or tricks.",
                    creatureTypes = listOf("Treefolk")),
            )
        ),
        "DOM" to SetSynergies(
            setCode = "DOM",
