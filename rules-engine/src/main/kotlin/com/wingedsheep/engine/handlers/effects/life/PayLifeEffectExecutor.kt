 ...
 */
class PayLifeEffectExecutor(private val zones: ZoneTransitionService) : EffectExecutor<PayLifeEffect> {
    ...
    override fun execute(
        ...
        val (newState, events) = LifePaymentService.pay(zones, state, context.controllerId, effect.amount)
